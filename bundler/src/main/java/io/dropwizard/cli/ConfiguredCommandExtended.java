 ...
 * @see Configuration
 */
public abstract class ConfiguredCommandExtended<T extends Configuration> extends Command {
    private boolean asynchronous;

    private T configuration;

    protected ConfiguredCommandExtended(String name, String description) {
