 ...
 * @see Configuration
 */
//changed: extends ConfiguredCommandExtended
//public abstract class EnvironmentCommand<T extends Configuration> extends ConfiguredCommand<T> {
public abstract class EnvironmentCommandExtended<T extends Configuration> extends ConfiguredCommandExtended<T> {
    //changed: protected
     ...
     */
    protected EnvironmentCommandExtended(Application<T> application, String name, String description) {
        super(name, description);
        this.application = application;
    }

    @Override
    //changed: removed final
